...
import com.translatealll.anguagesapp.model.PhrasesModelClass;
import com.translatealll.anguagesapp.utils.TranslateLanguage;

import java.util.ArrayList;


public class PhrasesDetailedActivity extends AppCompatActivity {
    ArrayList<PhrasesModelClass> complete_list = new ArrayList<>();
    String lang1name;
    String lang2name;
    int phraseposition;
    String[] phrases_list;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phrases_detailed);
        ...
        if (str.equals(TranslateLanguage.ARABIC)) {
            c = 0;
        } else if (str.equals(TranslateLanguage.GERMAN)) {
            c = 1;
        } else if (str.equals(TranslateLanguage.ENGLISH)) {
            c = 2;
        } else if (str.equals(TranslateLanguage.FRENCH)) {
            c = 3;
        } else if (str.equals(TranslateLanguage.HINDI)) {
            c = 4;
        } else if (str.equals(TranslateLanguage.ITALIAN)) {
            c = 5;
        } else if (str.equals(TranslateLanguage.JAPANESE)) {
            c = 6;
        } else if (str.equals(TranslateLanguage.RUSSIAN)) {
            c = 7;
        } else if (str.equals(TranslateLanguage.URDU)) {
            c = 8;
        } else if (str.equals(TranslateLanguage.CHINESE)) {
            c = 9;
        } else {
            c = 0;
        }
        ...
        for (int i = 0; i < phrases_list.length - 1; i++) {
            complete_list.add(new PhrasesModelClass(phrases_list[i]));
        }
