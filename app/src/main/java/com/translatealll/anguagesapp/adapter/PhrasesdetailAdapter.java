...
public class PhrasesdetailAdapter extends RecyclerView.Adapter<PhrasesdetailAdapter.PhrasesdetailViewHolder> {
    ...
    String lng1name;
    String lng2name;
    ArrayList<PhrasesModelClass> phraseslist;
    TextToSpeech txttospeech;


    boolean dropDown = false;

    public PhrasesdetailAdapter(Context context, ArrayList<PhrasesModelClass> phraseslist, String lng1name, String lng2name) {
    ...
    public PhrasesdetailViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new PhrasesdetailViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.phrasesdetail_singlerow, parent, false));
    }
    ...
    public void onBindViewHolder(PhrasesdetailViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        if (this.lng1name.equals(TranslateLanguage.URDU) || this.lng1name.equals(TranslateLanguage.ARABIC)) {
