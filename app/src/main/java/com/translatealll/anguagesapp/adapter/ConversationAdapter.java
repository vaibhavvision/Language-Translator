...
public class ConversationAdapter extends RecyclerView.Adapter<ConversationAdapter.ChatViewHolder> {
    ...
    public ConversationAdapter(Context context, ArrayList<ChatTable> chat_list) {
    ...
    public ChatViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ChatViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_convsersation, parent, false));
    }
