...
public class BottomSheetParagraphFragment extends BottomSheetDialogFragment  {
    ...
    public BottomSheetParagraphFragment(ParagraphDialogAdapter.PhraseDialogInterface phraseInterface) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        for (int i = 0; i < paragraphName.length; i++) {
            arrayList.add(new Paragraph(paragraphName[i],paragraphImage[i]));
        }
